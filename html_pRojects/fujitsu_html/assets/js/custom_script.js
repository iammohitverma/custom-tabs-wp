...
let headerToggle = document.querySelector(".toggle_menu");
...
let tabBtns = document.querySelectorAll(".tabs_wrap .tab_head button");
let tabContents = document.querySelectorAll(".tabs_wrap .tab_content");
tabBtns.forEach(button => {
    button.onclick = (event) => {
        ...
        let currTab = currBtn.dataset.tab;
